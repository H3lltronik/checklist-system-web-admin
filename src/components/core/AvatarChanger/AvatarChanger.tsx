...
import { AbsoluteCenteredLoader } from "../AbsoluteCenteredLoader";
...
export const AvatarChanger = (props: AvatarChangerProps) => {
  ...
  return (
    <div className="flex flex-col gap-5 justify-center align-middle">
      ...
      <div className="!w-[150px] !h-[150px] rounded-full relative overflow-hidden border">
        <Image
        ...
        />
        <AbsoluteCenteredLoader isLoading={loading} />
      </div>

      <Button onClick={handleChangeClick}>Cambiar imagen</Button>
    </div>
  );
};
